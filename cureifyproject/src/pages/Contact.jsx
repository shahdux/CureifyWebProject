                ...
                <div className="contactForm">
                    ...
                    <div className="inputDivholder">
                        <div className="twoinputs">
                            <input onChange={(e) => setFirstName(e.target.value)} className="nameinput" type="text" placeholder="Name"/>
                            <input onChange={(e) => setLastName(e.target.value)} className="nameinput" type="text" placeholder="Email"/>
                        </div>
                        <input onChange={(e) => setEmail(e.target.value)} className="nameinput longerwidth" type="text" placeholder="Subject"/>
                        <input onChange={(e) => setMessage(e.target.value)} className="nameinput p2" type="text" placeholder="Enter your message here.."/>
                        <div onClick={saveMessage} className='submitButton'>
                            <p className='subButton'>Submit</p>
                        </div>
                        {sent && <p className='subButton sentm'>✓ Message sent successfully!</p>}
                    </div>
                </div>
            </div>
